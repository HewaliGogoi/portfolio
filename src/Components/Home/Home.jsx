		...
		<div ref={scrollRef}>
			...
			>
				...
				>
					...
					<h1>
						I am a Full Stack Developer based in Sivasagar. I build
						things for web.
					</h1>
					<div className={styles.btn}>
						
						<a href='https://drive.google.com/file/d/1lhoBSaytviJkx-KvTERaVyK73jhQBXh4/view?usp=sharing' target='_blank' rel='noopener noreferrer'>
							<Button
								text={
